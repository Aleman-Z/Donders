...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%AUTHOR: Adrián Alemán Zapata. Master Student at TU Eindhoven. 
%RESEARCH ADVISOR:1)Francesco Battaglia. Donders Institute of Brain, Cognition and Behaviour, ru.nl/donders    
%2017
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
T6=cell(length(transamp),1);% NREM Reference timestamps (Identical for all other channels)
